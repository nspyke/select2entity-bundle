...
use Nspyke\Select2EntityBundle\Form\DataTransformer\EntitiesToPropertyTransformer;
use Nspyke\Select2EntityBundle\Form\DataTransformer\EntityToPropertyTransformer;
...
class Select2EntityType extends AbstractType
{
    ...
    public function __construct(protected readonly ManagerRegistry $registry, protected readonly RouterInterface $router, protected readonly array $config)
    {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        if ($options['transformer']) {
            ...
            if (!$transformer instanceof DataTransformerInterface) {
                throw new \Exception(sprintf('The custom transformer %s must implement "Symfony\Component\Form\DataTransformerInterface"', $transformer::class));
            }
